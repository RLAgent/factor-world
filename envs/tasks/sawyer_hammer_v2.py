...
class SawyerHammerEnvV2(SawyerXYZEnv):
  MODEL_NAME = full_v2_path_for('sawyer_xyz/sawyer_hammer.xml')
  ...
  def reset_model(self):
    ...
    self.obj_init_pos = self.obj_init_pos.copy()
    self._set_hammer_xyz(self.obj_init_pos)
