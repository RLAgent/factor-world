...
class SawyerPegInsertionSideEnvV2(SawyerXYZEnv):
  ...
  """
  MODEL_NAME = full_v2_path_for('sawyer_xyz/sawyer_peg_insertion_side.xml')
  TARGET_RADIUS = 0.07
  ...
  def evaluate_state(self, obs, action):
    ...
    grasp_success = float(tcp_to_obj < 0.02 and (
        tcp_open > 0) and (obj[2] - 0.01 > self.obj_init_pos[2]))
