...
class SawyerShelfPlaceEnvV2(SawyerXYZEnv):
  MODEL_NAME = full_v2_path_for('sawyer_xyz/sawyer_shelf_placing.xml')
  ...
  def reset_model(self):
    ...
    self.sim.model.body_pos[self.model.body_name2id(
        'shelf')] = self.goal.copy() - np.array([0, 0, 0.3])
    self._target_pos = self.sim.model.site_pos[self.model.site_name2id(
        'goal')] + self.sim.model.body_pos[self.model.body_name2id('shelf')]
